...
# ############################################################################ Compute a PCA (eigenfaces) on the face
#  dataset (treated as unlabeled dataset): unsuperxised feature extraction/ dimensionality reduction
n_components = 150
...
###############################################################################
# Quantitative evaluation of the prediction using  matplotlib
